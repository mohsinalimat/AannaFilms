...
//  AannaFilms
//
//  Created by Pradheep Rajendirane on 17/04/2016.
...
struct MovieLayoutConstants {
    struct Cell {
        ...
        static let standardHeight: CGFloat = UIScreen.mainScreen().bounds.height * 1/4
        /* The height of the first visible cell */
        static let featuredHeight: CGFloat = UIScreen.mainScreen().bounds.height /** 3/4*/
    }
}
...
class MovieLayout: UICollectionViewLayout {
    ...
    let dragOffset: CGFloat = MovieLayoutConstants.Cell.standardHeight
